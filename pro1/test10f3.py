...
func1('김밥')  # ('김밥',) 이렇게 받는거 꼭 기억
func1('김밥', '비빔밥') # ('김밥', '비빔밥')
func1('김밥', '비빔밥', '공기갑', '주먹밥')
...
# 몸무게 : 80, 키 : 180
# 기타 : {'irum': '신기해', 'nai' : 33} dict로 받아 값형태로 받음
# func3(80, 180, {'irum':'신기해', 'nai':33}) # dict 로 미리만들면 TypeError: func3() takes 2 positional arguments but 3 were given
