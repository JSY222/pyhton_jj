...
class CashPayment(Payment): # 현금 결제 클래스 : 현금 할인 5%을 적용하여 결제
    def pay(self, amount):
...
def process_paymet(paymentAddr:Payment, amount:int) -> None: # 주소를 넘어옴
...
if __name__ == "__main__":
    ...
    process_paymet(p1, 10000)
    print()
    process_paymet(p2, 10000)
    print()
    process_paymet(PointPayment(), 10000)