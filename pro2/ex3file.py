...
# 파일 입출력에서는 보통 이렇게 사용
# with open("파일명", "모드", encoding='utc-8')
#       파일 처리 코드 ...
# 블록 종료시 파일 자동 close됨

try:
    # 파일 저장
    with open('ftext3.txt', mode='w', encoding='utc-8') as fobj1:
    ...
    print()
    # 파일 읽기
    with open('ftext3.txt', mode='r', encoding='utc-8') as fobj2:
        print(fobj2.read())
...
try:
    ...
    with open('hello.dat', mode='wb') as fobj3:
        pickle.dump(tupleData, fobj3) # 저장 - pickle.dump(대상, 파일객체)
    ...
    with open('hello.dat', mode='rb') as fobj4:
        ...
        print('a : ', a) # {'tom': '111-1111', '길동': '222-2222'}
        print('b : ', b) # ['마우스', '모니터']
